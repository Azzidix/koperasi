...
<head>
    ...
    <title>Simpanan | Koperasi Simpan Pinjam</title>
    <!-- Bootstrap CSS -->
    ...
    <link rel="stylesheet" href="<?=base_url()?>/admin/assets/vendor/datepicker/tempusdominus-bootstrap-4.css" />
    <link rel="stylesheet" href="<?=base_url()?>/admin/assets/vendor/inputmask/css/inputmask.css" />
</head>
...
<body>
                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link active" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-4" aria-controls="submenu-4"><i class="fa fa-fw fa-user"></i>Anggota</a>
                                <div id="submenu-4" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                    ...
                    <div class="col-xl-12">
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="page-header" id="top">
                                    <h2 class="pageheader-title">Tambah Simpanan </h2>
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                ...
                                <div class="card">
                                    <h5 class="card-header">Form Tambah Simpanan</h5>
                                    <div class="card-body">
                                        <form>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <label for="inputText5" class="col-form-label">Jumlah Simpanan</label>
                                                <input id="inputText5" name="jumlah" type="text" class="form-control">
                                            </div>
    ...
    <script src="<?=base_url()?>/admin/assets/vendor/inputmask/js/jquery.inputmask.bundle.js"></script>
    <script>
    $(function(e) {
        "use strict";
