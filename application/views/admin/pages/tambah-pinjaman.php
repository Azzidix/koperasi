...
<head>
    ...
    <title>Pinjaman | Koperasi Simpan Pinjam</title>
    <!-- Bootstrap CSS -->
                    ...
                    <div class="col-xl-12">
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="page-header" id="top">
                                    <h2 class="pageheader-title">Tambah Pinjaman </h2>
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                ...
                                <div class="card">
                                    <h5 class="card-header">Form Tambah Pinjaman</h5>
                                    <div class="card-body">
                                        <form>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <label for="inputText5" class="col-form-label">Jumlah Pinjaman</label>
