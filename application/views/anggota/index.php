...
<head>
    ...
    <title>Koperasi Admin - Dashboard</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Pinjaman</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">Rp.<?php if(empty($totpinj->jml)) { echo 0;} else { echo $totpinj->jml; }?></div>
                                        </div>
                                        <div class="col-auto">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Simpanan</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">Rp.<?php if(empty($totalsmp->jml)) { echo 0;} else { echo $totalsmp->jml; }?></div>
                                        </div>
                                        <div class="col-auto">
                        ...
                        <?php 
                                if(empty($totalsmp->jml)) {
                                    $totalsmp .= 0;
                                } else {
                                    $jumlah_total = $shu->jml;
                                    $jumlah_anggota = $totalsmp->jml; 
                                    $keuntungan = ($totung->jml * 40) / 100;
                                    $jumlah = ($jumlah_anggota / $jumlah_total) * $keuntungan;
                                }
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Keuntungan</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">Rp.<?=intval($jumlah)?></div>
                                        </div>
                                        <div class="col-auto">
                                            <i class="fas fa-dollar-sign fa-2x text-gray-300"></i>
                                        </div>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Kosipi 019</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
